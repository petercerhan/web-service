from mathapp.student.data_mapper.exercise_event.orm_exercise_event import ORMExerciseEvent

class ExerciseEventFactory:
    ...
    def create(self, fields):
        ...
        orm_exercise_event = ORMExerciseEvent(student_id=student_id,
        ...
        self._unit_of_work.register_created(orm_exercise_event)
        exercise_event = orm_exercise_event.get_model(unit_of_work=self._unit_of_work)
