...
var InstructionSectionList = function (_React$Component) {
	...
	function InstructionSectionList(props) {
		...
		var concept_tutorial = JSON.parse(_this.props.concept_tutorial_json);
		_this.state = {
...
var dataContainer = document.getElementById('concept_tutorial_json');

ReactDOM.render(React.createElement(InstructionSectionList, { concept_tutorial_json: dataContainer.getAttribute('concept_tutorial_json') }), root);
