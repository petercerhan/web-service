...
def diagram_exercise_to_enriched_data(diagram_exercise):
	topic = topic_to_data(diagram_exercise.get_topic())
	diagram_image_data = diagram_exercise.get_diagram_image_data()
	diagram_image_data_base64 = base64.b64encode(diagram_image_data).decode('utf-8')
