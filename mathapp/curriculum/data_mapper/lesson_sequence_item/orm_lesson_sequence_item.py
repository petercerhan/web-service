...
from mathapp.curriculum.data_mapper.lesson_prior.orm_lesson import ORMLessonPrior
...
class ORMLessonSequenceItem(Base):
    ...
    lesson = relationship('ORMLessonPrior', lazy='joined', back_populates='lesson_sequence_items')
